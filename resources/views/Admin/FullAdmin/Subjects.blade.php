...
<body>
    ...
    <div class="SubjectContainer">
        @foreach (App\Models\Subject::paginate(10) as $subject)
            <a href="/subject/{{ $subject->id }}" class="Subject" style="text-decoration: none;"
                id="button{{ $subject->id }}">
                ...
                <div class="textContainer">
                    ...
                    @endforeach
                    <br>
                    Lectures: {{ $subject->lectures }}<br>
                    Students Subscribed: {{ $subject->subscriptions }}
                </div>
            </a>
    ...
    <div style="margin-top:2.5%; width:50px; height:50px;">
        {{ App\Models\Subject::paginate(10)->links() }}
    </div>
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            const buttons = document.querySelectorAll('.Subject'); // Select all buttons
