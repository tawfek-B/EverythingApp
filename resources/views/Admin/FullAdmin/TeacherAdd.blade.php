        ...
        <div style="display:flex; flex-direction:column; align-items:center; margin-bottom:10%;">
            ...
            <div style="position: relative; width: fit-content; height: fit-content; line-height: 0;">
                <input type="text" name="teacher_number" id="teacher_number" placeholder="9XXXXXXXX"
                    ...
                    style="height: 20%; text-align: left; font-size: 40%; text-indent:30%; width: 100%; box-sizing: border-box; @error('teacher_number') border:2px solid red @enderror; vertical-align: top; margin: 0; padding: 0;"
